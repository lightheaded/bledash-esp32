...
/* bledash: rename all micro-ecc symbols to ef_uECC_* to avoid colliding with
 * NimBLE's bundled tinycrypt uECC_*. Must come before any declaration below and
 * before uECC.c's include of uECC_vli.h. See ef_uecc_prefix.h. */
#include "ef_uecc_prefix.h"
